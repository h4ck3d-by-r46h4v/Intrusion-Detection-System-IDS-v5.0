...
system('sh /root/Desktop/ids/Firewall/Ip_Address_Blocking.sh');
print "\n";
goto START2;
}
elsif($fire eq "2")
...
system('sh /root/Desktop/ids/Firewall/MAC_Filtering.sh');
print "\n";
goto START2;
}
elsif($fire eq "3")
...
system('sh /root/Desktop/ids/Firewall/Port_Filtering.sh');
print "\n";
goto START2;
}
elsif($fire eq "4")
...
system('sh /root/Desktop/ids/Firewall/Block_Website.sh');
print "\n";
goto START2;
}
elsif($fire eq "5")
...
system('sh /root/Desktop/ids/Firewall/Spamming_IP_Block.sh');
print "\n";
goto START2;
}
elsif($fire eq "6")
...
system('perl /root/Desktop/ids/Firewall/evil_shell_finder.pl');
print "\n";
goto START2;
}
elsif($fire eq "7")
...
system('perl /root/Desktop/ids/Firewall/Trojan_Scan.pl');
print "\n";
goto START2;
}
elsif($fire eq "8")
...
system('sh /root/Desktop/ids/Honeypot/fake_access_point.sh');
print "\n";
goto START3;
}
elsif($hone eq "2")
...
system('sh /root/Desktop/ids/Honeypot/kill_fake_access_point.sh');
print "\n";
goto START3;
}
elsif($hone eq "3")
...
system('sh /root/Desktop/ids/Honeypot/main.sh');
print "\n";
goto START3;
}
elsif($hone eq "4")
...
system('sh /root/Desktop/ids/Ddos/Final_Arp_Spoofing_detection.sh');
print "\n";
goto START4;
}
elsif($dos eq "2")
...
system('sh /root/Desktop/ids/Ddos/http.sh');
print "\n";
goto START4;
}
elsif($dos eq "3")
...
system('sh /root/Desktop/ids/Ddos/udp.sh');
print "\n";
goto START4;
}
elsif($dos eq "4")
...
system('sh /root/Desktop/ids/Ddos/Tcp-Ip.sh');
print "\n";
goto START4;
}
elsif($dos eq "5")
...
system('sh /root/Desktop/ids/Ddos/SYN.sh');
print "\n";
goto START4;
}
elsif($dos eq "6")
...
system('sh /root/Desktop/ids/Ddos/Establish-connection-attack.sh');
print "\n";
goto START4;
}
elsif($dos eq "7")
...
system('perl /root/Desktop/ids/Ddos/blockdos.pl');
print "\n";
goto START4;
}
elsif($dos eq "8")
...
system('sh /root/Desktop/ids/Ddos/main.sh');
print "\n";
goto START4;
}
elsif($dos eq "9")
...
system('sh /root/Desktop/ids/Ddos/PingOfDeathDetector.sh');
print "\n";
goto START4;
}
elsif($dos eq "10")
...
system('sh /root/Desktop/ids/Logs/a.sh');
print "\n";
goto START5;
}
if($log eq "2")
...
system('sh /root/Desktop/ids/Logs/b.sh');
print "\n";
goto START5;
}
if($log eq "3")
...
system('sh /root/Desktop/ids/Logs/c.sh');
print "\n";
goto START5;
}
if($log eq "4")
...
system('sh /root/Desktop/ids/Logs/System_Boot_Logs.sh');
print "\n";
goto START5;
}
if($log eq "5")
...
system('perl /root/Desktop/ids/Logs/LogCleaner.pl');
print "\n";
goto START5;
}
if($log eq "6")
...
system('sh /root/Desktop/ids/Logs/Logins_Logs_Attempt.sh');
print "\n";
goto START5;
}
elsif($log eq "7")
